...
p.body{font-size:16.5px;color:var(--sub);margin-bottom:14px;line-height:1.85;max-width:720px}
...
ul.pl{list-style:none;margin-top:16px;max-width:720px}
...
.faq p{padding:0 20px 18px;font-size:15.5px;color:var(--sub);line-height:1.7;max-width:760px}
