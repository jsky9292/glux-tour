...
const GUIDES = [
  ...
  ['osaka-3d4n-course', '오사카 3박4일 코스'], ['osaka-with-kids','아이와 오사카'], ['osaka-parents','부모님과 오사카'], ['osaka-shopping','오사카 쇼핑'], ['osaka-must-eat','오사카 명물 음식'],  ['osaka-cherry-autumn','오사카 벚꽃·단풍'], ['kyoto-cherry-autumn','교토 벚꽃·단풍'], ['kyoto-kimono','교토 기모노 체험'], ['osaka-night-view','오사카 야경'],  ['kyoto-1n2d-course', '교토 1박2일 코스'], ['kobe-day-trip-course', '고베 당일치기'], ['nara-day-trip-course', '나라 당일치기'], ['kansai-airport-access', '간사이공항 시내이동'], ['osaka-transit', '오사카 지하철·전철'], ['kansai-day-trip-trains', '근교 전철(교토·고베·나라)'], ['namba-area', '난바역 주변'], ['umeda-area', '우메다역 주변'], ['osaka-station-area', '오사카역·키타'], ['tennoji-area', '텐노지역 주변'], ['shin-osaka-area', '신오사카역'], ['shinsaibashi-area', '신사이바시·아메무라'], ['rinku-outlet', '린쿠 아울렛'], ['usj-guide', '유니버설 스튜디오'], ['osaka-like-local', '오사카 현지인처럼'], ['osaka-rainy-day', '비 오는 날 오사카'], ['osaka-neighborhoods', '오사카 골목 동네'], ['osaka-hotel', '오사카 호텔'],
